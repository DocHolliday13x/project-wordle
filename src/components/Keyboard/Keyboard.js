...
function getStatusByLetter(validatedGuesses) {
  ...
  // Here it produces an array containing all of the letter/status objects for each guess.
  ...
  allLetters.forEach(({ letter, status }) => {
    ...
    // For example, if the answer is "APPLE" and the user guesses "PAPER", then the letter "P" is misplaced (for the first P) and correct (for the second P).
